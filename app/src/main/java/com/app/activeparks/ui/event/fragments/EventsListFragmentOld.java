...
public class EventsListFragmentOld extends Fragment {

    private FragmentEventsBinding binding;
    private EventViewModel mViewModel;
    private String id = null;

    public EventsListFragmentOld(){}

    public EventsListFragmentOld(String id){
        this.id = id;
    }
    ...
    public void setAdapter(SportEvents events) {
        ...
        binding.listEvents.setAdapter(new EventsListAdaperOld(getActivity(), events.getItems()).setOnEventListener(new EventsListAdaperOld.EventsListener() {
            @Override
